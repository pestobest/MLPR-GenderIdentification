...
import numpy
from Library_gianmarco import LBG_algorithm, Bayes_risk_min_cost, PCA, Ksplit, Z_norm, logpdf_GMM, plot_min_cdf_error_gaussian_mixture_models, vcol
...
if __name__ == "__main__":
    ...
    plot_min_cdf_error_gaussian_mixture_models_test("GMM", min_cost_vec, test_min_cost_vec, min_cost_vec_znorm, test_min_cost_vec_znorm, "RAW", "Z-Norm")
    ...
    min_cost_vec_znorm = train(Dz, L)
    test_min_cost_vec_znorm = test(Dz, L, DTEz, LTE)
    plot_min_cdf_error_gaussian_mixture_models_test("GMM PCA-12", min_cost_vec, test_min_cost_vec, min_cost_vec_znorm, test_min_cost_vec_znorm, "RAW", "Z-Norm")
