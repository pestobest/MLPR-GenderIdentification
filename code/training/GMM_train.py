...
import numpy
from library import load, LBG_algorithm, Bayes_risk_min_cost, PCA, Ksplit, Z_norm, logpdf_GMM, plot_min_cdf_error_gaussian_mixture_models
...
if __name__ == "__main__":
    ...
    plot_min_cdf_error_gaussian_mixture_models("GMM PCA-11", min_cost_vec, min_cost_vec_znorm, "RAW", "Z-Norm")
