...
import numpy
from library import load, tied_covariance_gaussian_classier, Bayes_risk_min_cost, PCA, Ksplit, Z_norm
...
if __name__ == '__main__':
    ...
    print("Tied Covariance model RAW features")
    priors = [0.5, 0.1, 0.9]
    for p in priors:
        print("Prior:", p)
        for m in range(7, 13):
    ...
    D = Z_norm(D)
    print("Tied Covariance model Z-norm features")
    for p in priors:
        print("Prior:", p)
        for m in range(7, 13):
            print("PCA:", m)
