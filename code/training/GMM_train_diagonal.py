...
import numpy
from Library_gianmarco import LBG_algorithm_diagonal, Bayes_risk_min_cost, PCA, Ksplit, Z_norm, logpdf_GMM, plot_min_cdf_error_gaussian_mixture_models
...
if __name__ == "__main__":
    ...
    plot_min_cdf_error_gaussian_mixture_models("GMM diagonal", min_cost_vec, min_cost_vec_znorm, "RAW", "Z-Norm")
    ...
    plot_min_cdf_error_gaussian_mixture_models("GMM diagonal PCA-12", min_cost_vec, min_cost_vec_znorm, "RAW", "Z-Norm")
    ...
    plot_min_cdf_error_gaussian_mixture_models("GMM diagonal PCA-11", min_cost_vec, min_cost_vec_znorm, "RAW", "Z-Norm")
